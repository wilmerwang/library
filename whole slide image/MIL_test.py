...
parser.add_argument('--lib', type=str, default='./data_preprocess/config.pth', help='path to data file')
parser.add_argument('--output', type=str, default='../model', help='name of output directory')
parser.add_argument('--model', type=str, default='../model/checkpoint_best.pth', help='path to pretrained model')

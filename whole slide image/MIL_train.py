...
parser.add_argument('--train_lib', type=str, default='./data_preprocess/config.pth', help='path to train MIL library binary')
parser.add_argument('--val_lib', type=str, default='./data_preprocess/config.pth', help='path to validation MIL library binary. If present.')
parser.add_argument('--output', type=str, default='../model/', help='name of output file')
...
parser.add_argument('--k', default=3, type=int, help='top k tiles are assumed to be of the same class as the slide (default: 1, standard MIL)')
